...
workflow.add_node('agente_recepcionista', Nodes.recepcionista)
workflow.add_node('agente_orquestrador', Nodes.orquestrador)
workflow.add_node('agente_rag', Nodes.rag)
workflow.add_node('agente_agendamento', Nodes.agendamento)
